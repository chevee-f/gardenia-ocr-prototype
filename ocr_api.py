...
# DATABASE_URL = "postgresql://ervy_brokerage_03_user:vHWjqRVw9npdpFnnsO2yUj8Gx70QxcsG@dpg-d139jfumcj7s7384a9lg-a.oregon-postgres.render.com/ervy_brokerage_03"
DATABASE_URL = "postgresql://brk_01_user:novoGcJSLa6cmOJt7nlhdTbAln4Ircyv@dpg-d1s9r5ruibrs73a67q50-a.oregon-postgres.render.com/brk_01"
...
@app.route('/save-dr', methods=['POST'])
def save_dr():
    print('saving dr#')
    data = request.get_json()
